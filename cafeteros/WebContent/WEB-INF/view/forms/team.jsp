...
<c:set var="teamForm" scope="request">
	<form method="post" name="addTeam">
		...
		<div class="form-group">
			...
			<input type="text" name="teamName" class="form-control" id="inputTeamName" aria-describedby=""/>
		...
		<div class="form-group">
			...
			<textarea class="form-control" rows="2" name="teamIntroduction" id="inputIntroduction">This introduction will be show along with all the teams of the club. This small description will help player to identify it this team fits on his needs</textarea>
		...
		<div class="form-group">
			...
			<textarea class="tinymceTextarea form-control" name="teamDescription" id="inputTeamDescription">
		...
		<div class="form-group">
			...
			<textarea class="tinymceTextarea form-control" name="teamEnrollmentAgreement" id="inputTeamAgreement">
